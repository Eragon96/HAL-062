...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    private void launchEnginesControl() {
...
//***remember the conncction will fail and app will crash if you haven't paired first
    public void startConnection(){
        //if(mAPP.getBluetoothConnection() != null){ mAPP.cancel(); }
        mAPP.setBluetoothDevice(mBTDevice);
        if(mAPP.getBluetoothDevice() != null) {
            mAPP.startBTConnectionService(MainActivity.this);
            mAPP.startBTConnection();
